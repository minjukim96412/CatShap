          ...
          <div class="backgroundhorizontalbordersh35">
            ...
            <div class="category-name-parent">
              <div class="category-name">
                <div class="div417"><a href="#">간식</a></div>
              </div>
              <div class="category-name">
                <div class="div417"><a href="#">사료</a></div>
              </div>
              <div class="category-name">
                <div class="div417"><a href="#">장난감</a></div>
              </div>
              <div class="category-name">
                <div class="div417"><a href="#">옷</a></div>
              </div>
              <div class="category-name4">
                <div class="div421 div417"><a href="#">기타</a></div>
              </div>
